CREATE TABLE public.parts_of_speech_domain
(
  tag text NOT NULL,
  description text,
  examples text,
  CONSTRAINT pk_pos_tag PRIMARY KEY (tag)
);
--;;

INSERT INTO parts_of_speech_domain (tag, description, examples)
VALUES ('$', 'dollar', '$ -$ --$ A$ C$ HK$ M$ NZ$ S$ U.S.$ US$'),
       ...
       ('LS', 'list item maker', 'A A. B B. C C. D E F First G H I J K One SP-44001 SP-44002 SP-44005 SP-44007 Second Third Three Two \* a b c d first five four one six three two'),
       ('MD', 'modal auxilliary', $$can cannot could couldn't dare may might must need ought shall should shouldn't will would$$),
       ('NN', 'noun, proper, singular', 'common-carrier cabbage knuckle-duster Casino afghan shed thermostat investment slide humour falloff slick wind hyena override subhumanity machinist ...'),
       ...
       ('PRP$', 'pronoun possesive', 'her his mine my our ours their thy your'),
